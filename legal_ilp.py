...
def main():
    ...
    prep_path = r"C:\Users\Rahul Rangavazzala\Desktop\Sem6\NLP\DELSumm-main\prepared\prepared_data.json"
    summary_path = r"C:\Users\Rahul Rangavazzala\Desktop\Sem6\NLP\DELSumm-main\summaries\\"
    parser.add_argument('--prep_path',  type = str, help = 'Path where the prepared data is stored in json format', default=prep_path)
    parser.add_argument('--summary_path',  type = str, help = 'Folder to store the summaries of the documents', default=summary_path)
