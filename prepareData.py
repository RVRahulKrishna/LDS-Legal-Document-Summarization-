...
data_path = r"C:\Users\Rahul Rangavazzala\Desktop\Sem6\NLP\DELSumm-main\docs"
prep_path = r"C:\Users\Rahul Rangavazzala\Desktop\Sem6\NLP\DELSumm-main\prepared\\"
    
parser.add_argument('--data_path', type = str, help = 'Folder containing documents to be summarized', default=data_path)
parser.add_argument('--prep_path', type = str, help = 'Path to store the prepared data in json format', default=prep_path)
